                        ...
                        {Array.from({ length: 10 }).map((_, idx) => {
                            return (
                                <tr key={idx} className="border-b border-white/10">
                                    ...
                                    <td className="py-3 px-4 text-sm text-zinc-300">7832642</td>
                                    <td className="py-3 px-4 text-sm text-zinc-300">
                                        <div className="flex flex-col gap-1">
                                            <span className="font-semibold text-white">Geovane dos Santos Medina</span>
                                            <span>geeomedina@hotmail.com</span>
                                        </div>
                                    </td>
